...
export async function POST(req) {
  ...
  const [{ data: isStaff }, { data: isExec }, { data: isAdmin }] = await Promise.all([
  ...
  const { data, error } = await supabase.rpc("orders_claim", { p_order_id: orderId });
